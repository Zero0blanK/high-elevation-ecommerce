...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Update <span class="font-medium">{{ $category->name }}</span></p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            <div class="flex items-start gap-5">
                <div class="flex-shrink-0 w-24 h-24 rounded-lg border-2 border-dashed border-gray-300 overflow-hidden flex items-center justify-center bg-gray-50">
                    ...
                    <template x-if="!imagePreview && !removeImage && '{{ $category->image_url }}'">
                ...
                <div class="flex-1 space-y-2">
                    ...
                    <p class="text-xs text-gray-400">PNG, JPG or WebP. Recommended size 400×400px.</p>
                    @if($category->image_url)
                        <label class="inline-flex items-center gap-2 cursor-pointer text-sm text-red-500 hover:text-red-600">
                            <input type="checkbox" name="remove_image" value="1" x-model="removeImage" class="rounded border-gray-300 text-red-600 focus:ring-red-500">
        ...
        {{-- SEO Section --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5"
             x-data="{ open: {{ old('meta_title', $category->meta_title) || old('meta_description', $category->meta_description) ? 'true' : 'false' }} }">
