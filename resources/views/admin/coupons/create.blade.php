...
@section('content')
<div x-data="{
    discountType: '{{ old('type', 'fixed_amount') }}',
    generateCode() {
    ...
    <form method="POST" action="{{ route('admin.coupons.store') }}">
        ...
        <div class="space-y-6">
                ...
                <div class="p-6 space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <div class="flex">
                                <input type="text" name="code" id="code" value="{{ old('code') }}" required placeholder="e.g. BREW-2024" class="flex-1 border-gray-300 rounded-l-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm uppercase font-mono tracking-wider @error('code') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="description" id="description" value="{{ old('description') }}" placeholder="Brief description of the coupon" class="block w-full border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('description') border-red-300 @enderror">
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="value" id="value" value="{{ old('value') }}" required step="0.01" min="0" placeholder="0.00" class="block w-full pl-8 border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('value') border-red-300 @enderror">
                            </div>
                            @error('value')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="minimum_amount" id="minimum_amount" value="{{ old('minimum_amount') }}" step="0.01" min="0" placeholder="0.00" class="block w-full pl-8 border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('minimum_amount') border-red-300 @enderror">
                            </div>
                        ...
                        <div x-show="discountType === 'percentage'" x-transition>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="maximum_discount" id="maximum_discount" value="{{ old('maximum_discount') }}" step="0.01" min="0" placeholder="No limit" class="block w-full pl-8 border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('maximum_discount') border-red-300 @enderror">
                            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit') }}" min="0" placeholder="Unlimited" class="block w-full border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('usage_limit') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="usage_limit_per_customer" id="usage_limit_per_customer" value="{{ old('usage_limit_per_customer') }}" min="0" placeholder="Unlimited" class="block w-full border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('usage_limit_per_customer') border-red-300 @enderror">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="datetime-local" name="starts_at" id="starts_at" value="{{ old('starts_at') }}" class="block w-full border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('starts_at') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="expires_at" id="expires_at" value="{{ old('expires_at') }}" class="block w-full border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 shadow-sm sm:text-sm @error('expires_at') border-red-300 @enderror">
            ...
            <div class="flex items-center justify-end gap-3 pt-2">
                <a href="{{ route('admin.coupons.index') }}" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium px-4 py-2 rounded-lg transition-colors text-sm">Cancel</a>
